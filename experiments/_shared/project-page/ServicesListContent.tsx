...
import type { ServiceListRow } from './types'
...
/** Services list body for the Resources tab (search, filter, table). */
export function ServicesListContent() {
  const { services } = useProjectPageData()
  ...
  }, [search, services, showOnlyWithAlerts])
