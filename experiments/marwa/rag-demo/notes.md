...
- **Screen 3:** Choose a data source — sample templates (e-commerce, DevOps runbook, Support FAQ, technical docs) or upload TXT up to 10 MB. Invalid files stay on this screen with FileInput errors. Start demo continues to processing.
