...
const SMALL_SERVICE_COUNT = 8

/** Roll-ups and grouped attention kick in at this size. */
  ...
  for (let i = 0; i < TOTAL_SERVICES; i++) {
    ...
    if (i === 4 || i === 22) {
      ...
      if (i === 4) {
        ...
        attentionReason = 'Data access revoked'
...
const ALL_ACTIVITY: OverviewActivity[] = [
...
export const overviewDatasetSmall: OverviewDataset = {
  ...
  appsCount: 2,
  agentsCount: 1,
  services: ALL_SERVICES.slice(0, SMALL_SERVICE_COUNT),
