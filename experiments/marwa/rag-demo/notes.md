...
- **Screen 3:** Choose a data source — sample templates (e-commerce, DevOps runbook, Support FAQ, technical docs) or upload PDF/TXT/CSV/JSON up to 10 MB. Invalid files stay on this screen with FileInput errors. Start demo continues to processing.
...
- **Screen 6:** Results explained — why this mode matched, how High / Medium / Low was set, matched text + chunk. Back to results restores the last query and mode.
