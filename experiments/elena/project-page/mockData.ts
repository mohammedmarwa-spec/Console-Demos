...
export const projectPageData: ProjectPageMockData = {
  ...
  appsItems: [
    {
      id: 'marimo-postgres-demo',
      serviceName: 'marimo-postgres-demo',
      serviceType: 'Application',
      status: 'Running',
      planName: 'Startup-50-1024',
      planDetails: '0.5 vCPU / 1 GB RAM',
      cloudRegion: 'Amazon Web Services: eu-west-1',
      location: 'Europe, Ireland',
      created: '3 hours ago',
      items: [
        {
          id: 'marimo-postgres-pg',
          serviceName: 'marimo-postgres-pg',
          serviceType: 'PostgreSQL',
          serviceTypeId: 'postgresql',
          status: 'Running',
          nodeCount: 1,
    ...
    {
      id: 'streamlit-kafka-demo',
      serviceName: 'streamlit-kafka-demo',
      serviceType: 'Application',
      status: 'Running',
      planName: 'Startup-50-1024',
      planDetails: '0.5 vCPU / 1 GB RAM',
      ...
      items: [
        {
          id: 'streamlit-kafka-pg',
          serviceName: 'streamlit-kafka-pg',
          serviceType: 'PostgreSQL',
          serviceTypeId: 'postgresql',
          status: 'Running',
          nodeCount: 1,
    ...
    {
      id: 'analytics-clickhouse-app',
      serviceName: 'analytics-clickhouse-app',
      serviceType: 'Application',
      status: 'Running',
      planName: 'Startup-50-1024',
      planDetails: '0.5 vCPU / 1 GB RAM',
      cloudRegion: 'Amazon Web Services: ap-northeast-1',
      location: 'Asia, Japan',
      created: '2 days ago',
      items: [
        {
          id: 'analytics-clickhouse-svc',
          serviceName: 'analytics-clickhouse-svc',
          serviceType: 'ClickHouse',
          serviceTypeId: 'clickhouse',
          status: 'Running',
          nodeCount: 2,
