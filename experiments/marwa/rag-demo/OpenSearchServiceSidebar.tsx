        ...
        <>
          ...
          {showVectorDemo ? (
            <Navigation.Item
              icon={searchIcon}
              href="#"
              active={activeItem === 'vector-search-demo'}
              title="Vector search demo"
              aria-label="Vector search demo"
              onClick={go('vector-search-demo')}
            >
              {collapsed ? null : 'Vector search demo'}
            </Navigation.Item>
          ) : null}
