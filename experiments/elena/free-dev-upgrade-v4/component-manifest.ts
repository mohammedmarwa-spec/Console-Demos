...
export const componentManifest: ComponentManifest = {
  ...
  notes: [
    'ExperimentPageShell launcher for scenario "free-dev-upgrade-v4".',
    'Map describes shared ProjectServices (src/screens); UpgradeServiceModalV2 with dual Hobbyist clouds.',
  ],
}
