...
/** Official AWS wordmark path (Amazon_Web_Services_Logo.svg). */
const AWS_WORDMARK_PATH =
...
const AWS_SMILE_ARC =
  'M273.5,143.7c-32.9,24.3-80.7,37.2-121.8,37.2c-57.6,0-109.5-21.3-148.7-56.7c-3.1-2.8-0.3-6.6,3.4-4.4c42.4,24.6,94.7,39.5,148.8,39.5c36.5,0,76.6-7.6,113.5-23.2C274.2,133.6,278.9,139.7,273.5,143.7z'

const AWS_SMILE_ARROW =
...
function buildAwsLogoBody(wordmarkFill: string): string {
  return (
    '<g transform="translate(0, 3.21) scale(0.05263)">' +
    `<path fill="${wordmarkFill}" d="${AWS_WORDMARK_PATH}"/>` +
    `<path fill="${AWS_ORANGE}" fill-rule="evenodd" clip-rule="evenodd" d="${AWS_SMILE_ARC}"/>` +
    `<path fill="${AWS_ORANGE}" fill-rule="evenodd" clip-rule="evenodd" d="${AWS_SMILE_ARROW}"/>` +
    '</g>'
  )
}
