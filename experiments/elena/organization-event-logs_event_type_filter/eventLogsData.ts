...
/** API event_type values shown in the Event type filter dropdown. */
export const EVENT_TYPE_VALUES = [
  'account_support_contract_create',
  'account_support_contract_delete',
  'account_support_contract_update',
  'address_create',
  'address_delete',
  'address_update',
  'authentication_method_change_auth_token_extend_when_used',
  'authentication_method_change_auth_token_max_age_seconds',
  'authentication_method_change_auto_join_user_group',
  'authentication_method_change_organization_auth_policy',
  'authentication_method_create',
  'authentication_method_delete',
  'authentication_method_disable',
  'authentication_method_enable',
  'authentication_method_link_domain',
  'authentication_method_rename',
  'authentication_method_unlink_domain',
  'credit_memo_send_email',
  'custom_cloud_environment_created',
  'custom_cloud_environment_creation_done',
  'custom_cloud_environment_creation_failed',
  'custom_cloud_environment_deleted',
  'custom_cloud_environment_deletion_failed',
  'custom_cloud_environment_deletion_scheduled',
  'custom_cloud_environment_provisioning_started',
  'custom_cloud_environment_validation_done',
  'customer_managed_key_association',
  'customer_managed_key_create',
  'customer_managed_key_delete',
  'customer_managed_key_get',
  'customer_managed_key_list',
  'customer_managed_key_update',
  'discount_create',
  'discount_delete',
  'discount_update',
  'governance_request_operation_complete',
  'group_permissions_delete',
  'group_permissions_set',
  'integration_endpoint_user_config_secrets_read',
  'invite_accept',
  'invite_add',
  'invite_remove',
  'kafka_service_governance_disable',
  'kafka_service_governance_enable',
  'kafka_topic_request_approve_claim',
  'kafka_topic_request_approve_create',
  'kafka_topic_request_decline',
  'member_add',
  'member_delete',
  'one_time_charge_create',
  'one_time_charge_update',
  'organization_create',
  'organization_delete',
  'organization_update',
  'organization_vpc_create',
  'organization_vpc_delete',
  'organization_vpc_peering_connection_create',
  'organization_vpc_peering_connection_delete',
  'organization_vpc_route_create',
  ...
  'project_vpc_peering_connection_delete',
  'project_vpc_peering_connection_delete_detected',
  'project_vpc_route_create',
  'project_vpc_user_peer_network_cidrs_update',
  ...
  'service_revive',
  'service_update',
  'service_user_config_secrets_read',
  'service_user_secrets_read',
  'static_ip_address_associate',
  'static_ip_address_create',
  'static_ip_address_delete',
  'static_ip_address_dissociate',
  'static_ip_address_patch',
  'super_admin_add',
  'super_admin_deactivate_org_user',
  'super_admin_delete',
  'super_admin_reactivate_org_user',
  'super_admin_update_org_user_info',
  'team_create',
  'team_delete',
  'team_rename',
  'tier_change',
  'trial_credits_adjust',
  'trial_ended',
  'trial_extended',
  'trial_started',
  'unit_create',
...
/** Filter dropdown values, plus types present only in mock row templates. */
export type EventType = (typeof EVENT_TYPE_VALUES)[number] | 'disk_size_change'
...
export const EVENT_TYPE_OPTIONS: { value: (typeof EVENT_TYPE_VALUES)[number]; label: string }[] =
