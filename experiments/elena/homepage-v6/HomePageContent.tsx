...
export type HomePageContentProps = {
  /** Open the in-experiment project view (replaces cross-route navigation). */
  onOpenProject?: (projectId: string) => void
}

export function HomePageContent({ onOpenProject }: HomePageContentProps = {}) {
...
function RecentProjects({ onOpenProject }: { onOpenProject?: (projectId: string) => void }) {
  return (
